...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        ...
        self.assertEqual(['peanut', 'butter'], noms[0:-2]) # tambien puedo poner negativos en el slice
    ...
    def test_insertions(self):
        ...
        arr = ['you', 'shall', 'not', 'pass']
        arr.insert(0, 'Arthur')
        self.assertEqual(arr, knight)
    ...
    def test_use_deques_for_making_queues(self):
        ...
        # so a deque is a queue that can pop and insert from
        # both sides... if I just use one, then I've got a queue
