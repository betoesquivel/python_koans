...
class AboutStringManipulation(Koan):
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        #format rounds to the decimal place specified.
    ...
    def test_strings_can_be_split_with_different_patterns(self):
        ...
        # ',' or ';'
        # So re.compile builds a pattern object that can be used in several
        # ways. One of them is splitting a string based on a certain pattern.
